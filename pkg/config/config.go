...
type Config struct {
	...
	RequestRateLimitMax    int    `env:"REQUEST_RATE_LIMIT_MAX,required" envDefault:"10"`
	RequestRateLimitTTLSec int    `env:"REQUEST_RATE_LIMIT_TTL_SEC,required" envDefault:"86400"`
